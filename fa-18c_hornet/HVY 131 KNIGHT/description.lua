livery = {
	...
	{"pilot_F18_helmet", 0 ,"pilot_F18_helmet_27HI",false};
	{"pilot_F18_patch", 0 ,"pilot_F18_patch_knight",false};
...
name = "HVY 131 KNIGHT"
countries = {"USA", "RUS", "FRA", "UKR", "SPN", "NETH", "TUR", "BEL", "GER", "NOR", "CAN", "DEN", "UK", "GRG", "ISR", "ABH", "RSO", "ITA", "INS", "AUS","AUSAF"}